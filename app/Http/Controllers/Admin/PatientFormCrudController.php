...
class PatientFormCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::addColumn(['name' => 'gender' , 'label'=> trans('backpack::common.gender') , 'type'=>'text' ]);
        ...
        CRUD::addColumn(['name' => 'the_phone' , 'label'=> trans('backpack::common.the_phone') , 'type'=>'text' ]);
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::addField(['name' => 'the_phone' , 'label'=> trans('backpack::common.the_phone') , 'type'=>'text' ]);
